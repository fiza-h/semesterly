    ...
    return (
        <div
            style={{
                ...
                alignItems: 'flex-start', // Optional: Align items at the start
                padding: '20px',
            }}
        >
            <div>
                ...
                <SelectedCourses
                    ...
                    onCourseLockChange={handleCourseLockChange}
                />
            </div>
            ...
            <div>
                ...
                />
                <Table
                    schedule={schedules[currentPage]}
                    onCheckboxListChange={handleCheckboxList}
                />
            </div>
        </div>
    );    
